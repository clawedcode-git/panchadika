...
public abstract class Hilt_MmsReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((MmsReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectMmsReceiver(UnsafeCasts.<MmsReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
